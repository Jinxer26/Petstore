...
type GetInventoryHandlerFunc func(GetInventoryParams, any) middleware.Responder

// Handle executing the request and returning a response
func (fn GetInventoryHandlerFunc) Handle(params GetInventoryParams, principal any) middleware.Responder {
	return fn(params, principal)
}

// GetInventoryHandler interface for that can handle valid get inventory params
type GetInventoryHandler interface {
	Handle(GetInventoryParams, any) middleware.Responder
}
