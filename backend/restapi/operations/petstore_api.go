...
func NewPetstoreAPI(spec *loads.Document) *PetstoreAPI {
	return &PetstoreAPI{
		...
		StoreGetInventoryHandler: store.GetInventoryHandlerFunc(func(params store.GetInventoryParams, principal any) middleware.Responder {
			_ = params
			_ = principal
		...
		PetUploadFileHandler: pet.UploadFileHandlerFunc(func(params pet.UploadFileParams, principal any) middleware.Responder {
			_ = params
			_ = principal
