...
type UploadFileHandlerFunc func(UploadFileParams, any) middleware.Responder

// Handle executing the request and returning a response
func (fn UploadFileHandlerFunc) Handle(params UploadFileParams, principal any) middleware.Responder {
	return fn(params, principal)
}

// UploadFileHandler interface for that can handle valid upload file params
type UploadFileHandler interface {
	Handle(UploadFileParams, any) middleware.Responder
}
