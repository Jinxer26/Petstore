...
import (
	...
	"github.com/Jinxer26/Petstore/restapi/operations"
	"github.com/Jinxer26/Petstore/restapi/operations/pet"
	"github.com/Jinxer26/Petstore/restapi/operations/store"
	"github.com/Jinxer26/Petstore/restapi/operations/user"
)

//go:generate swagger generate server --target ../../backend --name Petstore --spec ../swagger/swagger.json --principal any
...
func configureAPI(api *operations.PetstoreAPI) http.Handler {
	...
	if api.StoreGetInventoryHandler == nil {
		api.StoreGetInventoryHandler = store.GetInventoryHandlerFunc(func(params store.GetInventoryParams, principal any) middleware.Responder {
			_ = params
			_ = principal
	...
	if api.PetUploadFileHandler == nil {
		api.PetUploadFileHandler = pet.UploadFileHandlerFunc(func(params pet.UploadFileParams, principal any) middleware.Responder {
			_ = params
			_ = principal
